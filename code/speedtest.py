...
def speedtest():
    result={"provider":"n/a", "upload":0, "download":0}
    ...
    result["provider"] = config['client']['isp']

    result["download"] = ((dlspeed / 1000 / 1000) * args.units[1], args.units[0])
    result["upload"] = ((ulspeed / 1000 / 1000) * args.units[1], args.units[0])
